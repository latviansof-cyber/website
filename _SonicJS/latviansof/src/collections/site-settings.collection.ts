...
export default {
  ...
  schema: {
    ...
    properties: {
      ...
      squareQuickDonate10Url: { type: 'string', title: 'Square Quick Donate — $10 URL', default: '' },
      squareQuickDonate25Url: { type: 'string', title: 'Square Quick Donate — $25 URL', default: '' },
      squareQuickDonate50Url: { type: 'string', title: 'Square Quick Donate — $50 URL', default: '' },
