    ...
    return html`
      ...
      <main id="membership-page" class="bg-cream">
        ...
        <section class="pb-16 lg:pb-24">
          <div class="mx-auto max-w-6xl rounded-[2rem] bg-gradient-to-br from-latvian-red to-sunset-gold px-8 py-12 text-white shadow-xl sm:px-12 lg:flex lg:items-center lg:justify-between lg:gap-12 lg:px-20 lg:py-16" style="animation: membership-rise 700ms 320ms cubic-bezier(.22,1,.36,1) both">
            <div class="max-w-2xl">
              <p class="text-xs font-bold uppercase tracking-[0.2em] text-white/70">${isLv ? 'IESAISTIETIES' : 'GET INVOLVED'}</p>
