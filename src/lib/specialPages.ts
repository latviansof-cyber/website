...
Whether you have Latvian heritage, an interest in Baltic culture, or simply want to connect with a vibrant multicultural community, you are welcome.`
    ...
    lv: {
      title: 'Par apvienību',
      content: `Dārvinas Latviešu Apvienība ir kopienas organizācija, kas apvieno latviešus, latviešu pēcnācējus un Latvijas draugus visā Ziemeļu Teritorijā. Mēs piedāvājam draudzīgu vietu, kur kultūra, valoda un tradīcijas tiek kopīgotas, saglabātas un baudītas.
